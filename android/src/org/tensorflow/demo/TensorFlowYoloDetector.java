...
public class TensorFlowYoloDetector implements Classifier {
  ...
  // [HHJ] Increase max results.
  private static final int MAX_RESULTS = 13; //5;

  // [HHJ] Change number of classes to 1 (text)
  private static final int NUM_CLASSES = 1; //20;
...
//  };
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    // [HHJ] use fixed number of grids (13) for the tiny-yolo-voc model
